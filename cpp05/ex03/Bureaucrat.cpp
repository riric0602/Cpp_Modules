...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/12 11:02:33 by rchbouki          #+#    #+#             */
/*   Updated: 2024/03/02 15:45:42 by rchbouki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm& form)
{
	...
	{
		std::cout << _name << " couldn't sign " << form.getName() << "because they are too weak." << std::endl;
	}	
}
...
void	Bureaucrat::executeForm(AForm const & form)
{
	...
	catch (const AForm::ExecutionFailureException& e)
	{
		std::cout << _name << " couldn't execute " << form.getName() << " because they are not qualified." << std::endl;
	}
}
